...
console.log(fibCounter.getFibNumsByPosOfLasrtNum(7))
console.log(fibCounter.getFibNumsByPosOfLasrtNum(8))
console.log(fibCounter.getFibNumsByPosOfLasrtNum(21))
console.log(fibCounter.getFibNumsByPosOfLasrtNum(1))
